...
| Filtro fake news | Python (NLP, TF-IDF) | Classificazione testi con tecniche di NLP | [Vai al progetto](https://github.com/MarcoCadau76/Portfolio/tree/main/progetti/filtro-fake-news) |
...
| Analisi clienti banca | SQL (MySQL) | Feature engineering su dati bancari per ML | [Vai al progetto](progetti/analisi-clienti-banca/Progetto_banca.sql) |
